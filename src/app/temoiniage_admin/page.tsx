        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
          ...
          <div className="md:col-span-5 lg:col-span-5 space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold tracking-tight">Témoiniages de candidats</h1>
                <p className="text-muted-foreground">Suivre les témoiniages des autres.</p>
              </div>
            </div>

            <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
              <TemoiniagesTabs refreshTrigger={refreshTrigger} />
            </div>
          </div>
        </div>
      </div>
